...
public class GirlsShayaariActivity extends AppCompatActivity {

    private String json = "";
    private final String girls = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.girls_shayaari);
        ...
        setTitle("Girls Shayaari");
        try {
            java.io.InputStream inputstream1 = getAssets().open("girls.json");
        ...
        map = new Gson().fromJson(json, new TypeToken<ArrayList<HashMap<String, Object>>>() {
        }.getType());
    ...
    public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            cardview1.setCardBackgroundColor(0xFF43CBFF);
