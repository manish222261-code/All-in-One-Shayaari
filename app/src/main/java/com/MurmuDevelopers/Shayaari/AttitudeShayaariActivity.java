...
public class AttitudeShayaariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.attitude_shayaari);
        ...
        try{
            java.io.InputStream inputstream1 = getAssets().open("attitude.json");
    ...
    public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull Recyclerview1Adapter.ViewHolder _holder, @SuppressLint("RecyclerView") int _position) {
            ...
            textview1.setText(Objects.requireNonNull(map.get((int) _position).get("Uname")).toString());
            cardview1.setCardBackgroundColor(0xFFEAC9E8);
            cardview1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View _view) {
                    intent.putExtra("key", Objects.requireNonNull(map.get((int) _position).get("Uname")).toString());
                    intent.setClass(AttitudeShayaariActivity.this, ShowShayaariActivity.class);
