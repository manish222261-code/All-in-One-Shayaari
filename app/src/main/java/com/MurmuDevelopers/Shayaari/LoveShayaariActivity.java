...
public class LoveShayaariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.love_shayaari);
        ...
        setTitle("Love Shayaari");
        try {
            java.io.InputStream inputstream1 = getAssets().open("love.json");
    ...
    public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            cardview1.setCardBackgroundColor(0xFFEDC0D2);
