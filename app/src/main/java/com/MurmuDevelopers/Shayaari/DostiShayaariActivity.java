...
public class DostiShayaariActivity extends AppCompatActivity {

    private String json = "";
    private final String dosti = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dosti_shayaari);
    ...
    public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder _holder, @SuppressLint("RecyclerView") final int position) {
            ...
            cardview1.setCardBackgroundColor(0xFFB6FAA5);
